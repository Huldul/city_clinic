                    ...
                    <div class="surgery__doctors doctors">
                        ...
                        <div class="doctors__box">
                            ...
                            <p class="doctors__name">{{$worker->name}}</p>
                                ...
                                <a href="/kz/specialist/{{$worker->slug}}"><button class="doctors__btn">Кездесуді белгілеңіз</button></a>
                        </div>
                        @endforeach
                    </div>
                </section>
                <section class="page__services sub-services">
                    <h2 class="sub-services__title title">Ішкі қызметтер тізімі</h2>
                    ...
                    <div class="sub-services__box">
                        <div class="sub-services__group">
                            ...
                            <a class="sub-services__link" href="/service/{{$subdirection->slug}}">Қосымша мәліметтер</a>
                        </div>
