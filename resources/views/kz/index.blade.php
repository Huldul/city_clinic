        ...
        <main class="page">
            ...
            <section class="page__slider">
                <div class="page__slider-wrapper">
                    ...
                    <a href="/kz/directions" class="page__slider-link">Қосымша мәліметтер</a>
                </div>
            ...
            <section class="page__directions directions">
                <div class="directions__wrapper container">
                    <h2 class="directions__title title">Біздің бағыттар</h2>
                    <div class="directions__container">
                        ...
                        <a href="/direction/{{$direction->slug}}" class="directions__box">
                            ...
                            <button class="directions__link">Қосымша мәліметтер</button>
                        </a>
                        @endforeach
                    </div>
                    <a class="directions__other" href="/kz/directions">Барлығын көру</a>
                </div>
            </section>
            ...
            <section class="page__video video container">
                <h2 class="video__title title">Бейне</h2>
